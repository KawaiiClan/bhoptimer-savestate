...
{
	g_iStyleCount = Shavit_GetStyleCount();
...
public void Shavit_OnStyleConfigLoaded(int styles)
{
	...
	{
		Shavit_GetStyleStrings(i, sStyleName, g_sStyleStrings[i].sStyleName, sizeof(stylestring_st::sStyleName));
	}
...
public Action InitSavesDB(Handle &DbHNDL)
{
	...
	{
		SQL_TQuery(g_hRatingDB, SQL_ErrorCheckCallBack, "CREATE TABLE IF NOT EXISTS `saves` (`map` varchar(100) NOT NULL, `auth` int NOT NULL, `style` int NOT NULL, 
																								  `TbTimerEnabled` int NOT NULL, 
																								  `TfCurrentTime` float NOT NULL, 
																								  `TbClientPaused` int NOT NULL, 
																								  `TiJumps` int NOT NULL, 
																								  `TiStrafes` int NOT NULL, 
																								  `TiTotalMeasures` int, 
																								  `TiGoodGains` int, 
																								  `TfServerTime` int NOT NULL, 
																								  `TiKeyCombo` int NOT NULL, 
																								  `TiTimerTrack` int NOT NULL, 
																								  `TiMeasuredJumps` int, 
																								  `TiPerfectJumps` int, 
																								  `TfZoneOffset1` float, 
																								  `TfZoneOffset2` float, 
																								  `TfZoneOffset3` float, 
																								  `TfDistanceOffset1` float, 
																								  `TfDistanceOffset2` float, 
																								  `TfDistanceOffset3` float, 
																								  `TfAvgVelocity` float, 
																								  `TfMaxVelocity` float, 
																								  `TfTimescale` float NOT NULL, 
																								  `TiZoneIncrement` int, 
																								  `TiFullTicks` int NOT NULL, 
																								  `TiFractionalTicks` int NOT NULL, 
																								  `TbPracticeMode` int NOT NULL, 
																								  `TbJumped` int NOT NULL, 
																								  `TbCanUseAllKeys` int NOT NULL, 
																								  `TbOnGround` int NOT NULL, 
																								  `TiLastButtons` int, 
																								  `TfLastAngle` float, 
																								  `TiLandingTick` int, 
																								  `TiLastMoveType` int, 
																								  `TfStrafeWarning` float, 
																								  `TfLastInputVel1` float, 
																								  `TfLastInputVel2` float, 
																								  `TfLastInputVel3` float, 
																								  `Tfplayer_speedmod` float, 
																								  `TfNextFrameTime` float, 
																								  `TiLastMoveTypeTAS` int, 
																								  
																								  `CfPosition1` float NOT NULL, 
																								  `CfPosition2` float NOT NULL, 
																								  `CfPosition3` float NOT NULL, 
																								  `CfAngles1` float NOT NULL, 
																								  `CfAngles2` float NOT NULL, 
																								  `CfAngles3` float NOT NULL, 
																								  `CfVelocity1` float NOT NULL, 
																								  `CfVelocity2` float NOT NULL, 
																								  `CfVelocity3` float NOT NULL, 
																								  `CiMovetype` int NOT NULL, 
																								  `CfGravity` float NOT NULL, 
																								  `CfSpeed` float NOT NULL, 
																								  `CfStamina` float NOT NULL, 
																								  `CbDucked` int NOT NULL, 
																								  `CbDucking` int NOT NULL, 
																								  `CfDuckTime` float, 
																								  `CfDuckSpeed` float, 
																								  `CiFlags` int NOT NULL, 
																								  `CsTargetname` varchar(64) NOT NULL, 
																								  `CsClassname` varchar(64) NOT NULL, 
																								  `CiPreFrames` int NOT NULL, 
																								  `CbSegmented` int NOT NULL, 
																								  `CiGroundEntity` int, 
																								  `CvecLadderNormal1` float, 
																								  `CvecLadderNormal2` float, 
																								  `CvecLadderNormal3` float, 
																								  `Cm_bHasWalkMovedSinceLastJump` int, 
																								  `Cm_ignoreLadderJumpTime` float, 
																								  `Cm_lastStandingPos1` float, 
																								  `Cm_lastStandingPos2` float, 
																								  `Cm_lastStandingPos3` float, 
																								  `Cm_ladderSuppressionTimer1` float, 
																								  `Cm_ladderSuppressionTimer2` float, 
																								  `Cm_lastLadderNormal1` float, 
																								  `Cm_lastLadderNormal2` float, 
																								  `Cm_lastLadderNormal3` float, 
																								  `Cm_lastLadderPos1` float, 
																								  `Cm_lastLadderPos2` float, 
																								  `Cm_lastLadderPos3` float, 
																								  `Cm_afButtonDisabled` int, 
																								  `Cm_afButtonForced` int, 
																								  UNIQUE KEY `unique_index` (`map`,`auth`,`style`)) ENGINE=INNODB;");
	}
...
public void SQL_GetClientSaves(Handle owner, Handle hndl, const char[] error, int client)
{
	...
	for(i = 0; i <= g_iStyleCount; i++)
	{
		g_bHasSave[data][i] = false;
	}
	...
	if(SQL_GetRowCount(hndl) != 0)
	{
		...
		{
			g_bHasSave[data][SQL_FetchInt(hndl, 0)] = true;
		}
	}
}
...
{
	if(style != Shavit_GetBhopStyle(client) || Shavit_GetClientTrack(client) != TRACK_MAIN)
		return Plugin_Handled;
	
	arrayset(g_aSavestates[client], 0, sizeof(g_aSavestates[client]));
	Shavit_SaveCheckpointCache(client, client, g_aSavestates[client], -1, sizeof(g_aSavestates[client]));
	Shavit_StopTimer(client, true);
	
	char Query[8184];
	Format(Query, sizeof(Query), "REPLACE INTO `saves` (`map`, `auth`, `style`, 
														`TbTimerEnabled`, `TfCurrentTime`, `TbClientPaused`, `TiJumps`, 
														`TiStrafes`, `TiTotalMeasures`, `TiGoodGains`, `TfServerTime`, `TiKeyCombo`, `TiTimerTrack`, 
														`TiMeasuredJumps`, `TiPerfectJumps`, `TfZoneOffset1`, `TfZoneOffset2`, `TfZoneOffset3`, 
														`TfDistanceOffset1`, `TfDistanceOffset2`, `TfDistanceOffset3`, `TfAvgVelocity`, 
														`TfMaxVelocity`, `TfTimescale`, `TiZoneIncrement`, `TiFullTicks`, `TiFractionalTicks`, `TbPracticeMode`, 
														`TbJumped`, `TbCanUseAllKeys`, `TbOnGround`, `TiLastButtons`, `TfLastAngle`, 
														`TiLandingTick`, `TiLastMoveType`, `TfStrafeWarning`, 
														`TfLastInputVel1`, `TfLastInputVel2`, `TfLastInputVel3`, `Tfplayer_speedmod`, 
														`TfNextFrameTime`, `TiLastMoveTypeTAS`, 
														
														`CfPosition1`, `CfPosition2`, `CfPosition3`, 
														`CfAngles1`, `CfAngles2`, `CfAngles3`, 
														`CfVelocity1`, `CfVelocity2`, `CfVelocity3`, 
														`CiMovetype`, `CfGravity`, `CfSpeed`, `CfStamina`, 
														`CbDucked`, `CbDucking`, `CfDuckTime`, `CfDuckSpeed`, 
														`CiFlags`, `CsTargetname`, `CsClassname`, 
														`CiPreFrames`, `CbSegmented`, `CiGroundEntity`, 
														`CvecLadderNormal1`, `CvecLadderNormal2`, `CvecLadderNormal3`, 
														`Cm_bHasWalkMovedSinceLastJump`, `Cm_ignoreLadderJumpTime`, 
														`Cm_lastStandingPos1`, `Cm_lastStandingPos2`, `Cm_lastStandingPos3`, 
														`Cm_ladderSuppressionTimer1`, `Cm_ladderSuppressionTimer2`,  
														`Cm_lastLadderNormal1`, `Cm_lastLadderNormal2`, `Cm_lastLadderNormal3`, 
														`Cm_lastLadderPos1`, `Cm_lastLadderPos2`, `Cm_lastLadderPos3`, 
														`Cm_afButtonDisabled`, `Cm_afButtonForced`) 
														
												VALUES ('%s', %i, %i, %i, %f, %i, %i, 
														%i, %i, %i, %f, %i, %i, 
														%i, %i, %f, %f, %f, 
														%f, %f, %f, %f, 
														%f, %f, %i, %i, %i, %i, 
														...
														g_aSavestates[client].aSnapshot.iMeasuredJumps, g_aSavestates[client].aSnapshot.iPerfectJumps, g_aSavestates[client].aSnapshot.fZoneOffset[0], g_aSavestates[client].aSnapshot.fZoneOffset[1], g_aSavestates[client].aSnapshot.fZoneOffset[2], 
														g_aSavestates[client].aSnapshot.fDistanceOffset[0], g_aSavestates[client].aSnapshot.fDistanceOffset[1], g_aSavestates[client].aSnapshot.fDistanceOffset[2], g_aSavestates[client].aSnapshot.fAvgVelocity, 
														...
														g_aSavestates[client].aSnapshot.fLastInputVel[0], g_aSavestates[client].aSnapshot.fLastInputVel[1], g_aSavestates[client].aSnapshot.fLastInputVel[2], g_aSavestates[client].aSnapshot.fplayer_speedmod, 
...
public void LoadGame(int client, int style)
{
	...
	char Query[2048];
	Format(Query, sizeof(Query), "SELECT `style`, `TbTimerEnabled`, `TfCurrentTime`, `TbClientPaused`, `TiJumps`, 
										`TiStrafes`, `TiTotalMeasures`, `TiGoodGains`, `TfServerTime`, `TiKeyCombo`, `TiTimerTrack`, 
										`TiMeasuredJumps`, `TiPerfectJumps`, `TfZoneOffset1`, `TfZoneOffset2`, `TfZoneOffset3`, 
										`TfDistanceOffset1`, `TfDistanceOffset2`, `TfDistanceOffset3`, `TfAvgVelocity`, 
										`TfMaxVelocity`, `TfTimescale`, `TiZoneIncrement`, `TiFullTicks`, `TiFractionalTicks`, `TbPracticeMode`, 
										...
										`Cm_lastLadderPos1`, `Cm_lastLadderPos2`, `Cm_lastLadderPos3`, 
										`Cm_afButtonDisabled`, `Cm_afButtonForced` 
										FROM `saves` WHERE `map` = '%s' AND `auth` = %i AND `style` = %i;", g_sCurrentMap, GetSteamAccountID(client), style);
...
public void SQL_LoadGame(Handle owner, Handle hndl, const char[] error, any client)
{
	...
	else
	{
		Format(Query, sizeof(Query), "REPLACE INTO `saves` (`map`, `auth`, `style`, 
														...
														`Cm_lastLadderPos1`, `Cm_lastLadderPos2`, `Cm_lastLadderPos3`, 
														`Cm_afButtonDisabled`, `Cm_afButtonForced`) "
														g_sCurrentMap, GetSteamAccountID(client), g_aSavestates[client].aSnapshot.bsStyle, 
														);
		...
		else
		{
			while(SQL_FetchRow(hndl))
			{
				...
				g_aSavestates[client].aSnapshot.fZoneOffset[2] = SQL_FetchFloat(hndl, 15);
				...
				g_aSavestates[client].aSnapshot.fDistanceOffset[2] = SQL_FetchFloat(hndl, 18);
				g_aSavestates[client].aSnapshot.fAvgVelocity = SQL_FetchFloat(hndl, 19);
				g_aSavestates[client].aSnapshot.fMaxVelocity = SQL_FetchFloat(hndl, 20);
				g_aSavestates[client].aSnapshot.fTimescale = SQL_FetchFloat(hndl, 21);
				g_aSavestates[client].aSnapshot.iZoneIncrement = SQL_FetchInt(hndl, 22);
				g_aSavestates[client].aSnapshot.iFullTicks = SQL_FetchInt(hndl, 23);
				g_aSavestates[client].aSnapshot.iFractionalTicks = SQL_FetchInt(hndl, 24);
				g_aSavestates[client].aSnapshot.bPracticeMode = view_as<bool>(SQL_FetchInt(hndl, 25));
				g_aSavestates[client].aSnapshot.bJumped = view_as<bool>(SQL_FetchInt(hndl, 26));
				g_aSavestates[client].aSnapshot.bCanUseAllKeys = view_as<bool>(SQL_FetchInt(hndl, 27));
				g_aSavestates[client].aSnapshot.bOnGround = view_as<bool>(SQL_FetchInt(hndl, 28));
				g_aSavestates[client].aSnapshot.iLastButtons = SQL_FetchInt(hndl, 29);
				g_aSavestates[client].aSnapshot.fLastAngle = SQL_FetchFloat(hndl, 30);
				g_aSavestates[client].aSnapshot.iLandingTick = SQL_FetchInt(hndl, 31);
				g_aSavestates[client].aSnapshot.iLastMoveType = SQL_FetchInt(hndl, 32);
				g_aSavestates[client].aSnapshot.fStrafeWarning = SQL_FetchFloat(hndl, 33);
				g_aSavestates[client].aSnapshot.fLastInputVel[0] = SQL_FetchFloat(hndl, 34);
				g_aSavestates[client].aSnapshot.fLastInputVel[1] = SQL_FetchFloat(hndl, 35);
				g_aSavestates[client].aSnapshot.fLastInputVel[2] = SQL_FetchFloat(hndl, 36);
				g_aSavestates[client].aSnapshot.fplayer_speedmod = SQL_FetchFloat(hndl, 37);
				g_aSavestates[client].aSnapshot.fNextFrameTime = SQL_FetchFloat(hndl, 38);
				g_aSavestates[client].aSnapshot.iLastMoveTypeTAS = SQL_FetchInt(hndl, 39);
				g_aSavestates[client].fPosition[0] = SQL_FetchFloat(hndl, 40);
				g_aSavestates[client].fPosition[1] = SQL_FetchFloat(hndl, 41);
				g_aSavestates[client].fPosition[2] = SQL_FetchFloat(hndl, 42);
				g_aSavestates[client].fAngles[0] = SQL_FetchFloat(hndl, 43);
				g_aSavestates[client].fAngles[1] = SQL_FetchFloat(hndl, 44);
				g_aSavestates[client].fAngles[2] = SQL_FetchFloat(hndl, 45);
				g_aSavestates[client].fVelocity[0] = SQL_FetchFloat(hndl, 46);
				g_aSavestates[client].fVelocity[1] = SQL_FetchFloat(hndl, 47);
				g_aSavestates[client].fVelocity[2] = SQL_FetchFloat(hndl, 48);
				g_aSavestates[client].iMoveType = SQL_FetchInt(hndl, 49);
				g_aSavestates[client].fGravity = SQL_FetchFloat(hndl, 50);
				g_aSavestates[client].fSpeed = SQL_FetchFloat(hndl, 51);
				g_aSavestates[client].fStamina = SQL_FetchFloat(hndl, 52);
				g_aSavestates[client].bDucked = view_as<bool>(SQL_FetchInt(hndl, 53));
				g_aSavestates[client].bDucking = view_as<bool>(SQL_FetchInt(hndl, 54));
				g_aSavestates[client].fDucktime = SQL_FetchFloat(hndl, 55);
				g_aSavestates[client].fDuckSpeed = SQL_FetchFloat(hndl, 56);
				g_aSavestates[client].iFlags = SQL_FetchInt(hndl, 57);
				SQL_FetchString(hndl, 58, g_aSavestates[client].sTargetname, sizeof(g_aSavestates[client].sTargetname));
				SQL_FetchString(hndl, 59, g_aSavestates[client].sClassname, sizeof(g_aSavestates[client].sClassname));
				g_aSavestates[client].iPreFrames = SQL_FetchInt(hndl, 60);
				g_aSavestates[client].bSegmented = view_as<bool>(SQL_FetchInt(hndl, 61));
				g_aSavestates[client].iGroundEntity = SQL_FetchInt(hndl, 62);
				g_aSavestates[client].vecLadderNormal[0] = SQL_FetchFloat(hndl, 63);
				g_aSavestates[client].vecLadderNormal[1] = SQL_FetchFloat(hndl, 64);
				g_aSavestates[client].vecLadderNormal[2] = SQL_FetchFloat(hndl, 65);
				g_aSavestates[client].m_bHasWalkMovedSinceLastJump = view_as<bool>(SQL_FetchInt(hndl, 66));
				g_aSavestates[client].m_ignoreLadderJumpTime = SQL_FetchInt(hndl, 67);
				g_aSavestates[client].m_lastStandingPos[0] = SQL_FetchFloat(hndl, 68);
				g_aSavestates[client].m_lastStandingPos[1] = SQL_FetchFloat(hndl, 69);
				g_aSavestates[client].m_lastStandingPos[2] = SQL_FetchFloat(hndl, 70);
				g_aSavestates[client].m_ladderSurpressionTimer[0] = SQL_FetchFloat(hndl, 71);
				g_aSavestates[client].m_ladderSurpressionTimer[1] = SQL_FetchFloat(hndl, 72);
				g_aSavestates[client].m_lastLadderNormal[0] = SQL_FetchFloat(hndl, 73);
				g_aSavestates[client].m_lastLadderNormal[1] = SQL_FetchFloat(hndl, 74);
				g_aSavestates[client].m_lastLadderNormal[2] = SQL_FetchFloat(hndl, 75);
				g_aSavestates[client].m_lastLadderPos[0] = SQL_FetchFloat(hndl, 76);
				g_aSavestates[client].m_lastLadderPos[1] = SQL_FetchFloat(hndl, 77);
				g_aSavestates[client].m_lastLadderPos[2] = SQL_FetchFloat(hndl, 78);
				g_aSavestates[client].m_afButtonDisabled = SQL_FetchInt(hndl, 79);
				g_aSavestates[client].m_afButtonForced = SQL_FetchInt(hndl, 80);
			}
